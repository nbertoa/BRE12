...
void
ColorNormalCmdListRecorder::InitSharedPSOAndRootSignature(
...
void 
ColorNormalCmdListRecorder::Init(
...
bool 
ColorNormalCmdListRecorder::IsDataValid() const noexcept {
	const bool result =
...
void 
ColorNormalCmdListRecorder::InitConstantBuffers(
	const std::vector<MaterialProperties>& materialProperties,
