...
void ColorNormalCmdListRecorder::InitPSO(const DXGI_FORMAT* geometryBufferFormats, const std::uint32_t geometryBufferCount) noexcept {
	...
	ShaderManager::LoadShaderFile("GeometryPass/Shaders/ColorNormalMapping/PS.cso", psoData.mPixelShaderBytecode);
	ShaderManager::LoadShaderFile("GeometryPass/Shaders/ColorNormalMapping/VS.cso", psoData.mVertexShaderBytecode);

	ID3DBlob* rootSignatureBlob;
	ShaderManager::LoadShaderFile("GeometryPass/Shaders/ColorNormalMapping/RS.cso", rootSignatureBlob);
