...
VertexAndIndexBufferCreator::VertexBufferData::operator=(const VertexBufferData& instance)
{
    if (this == &instance) {
        return *this;
    }
...
VertexAndIndexBufferCreator::IndexBufferData::operator=(const IndexBufferData& instance)
{
    if (this == &instance) {
        return *this;
    }
