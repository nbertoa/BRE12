...
public:
	...
	__forceinline static HWND GetWindowHandle() noexcept { return mWindowHandle; }
	__forceinline static IDXGIFactory4& GetIDXGIFactory() noexcept { ASSERT(mDxgiFactory.Get() != nullptr); return *mDxgiFactory.Get(); }
	__forceinline static ID3D12Device& GetDevice() noexcept { ASSERT(mDevice.Get() != nullptr); return *mDevice.Get(); }
