...
void
EnvironmentLightCmdListRecorder::Init(ID3D12Resource& normalSmoothnessBuffer,
...
void
EnvironmentLightCmdListRecorder::InitShaderResourceViews(ID3D12Resource& normalSmoothnessBuffer,
                                                         ID3D12Resource& baseColorMetalMaskBuffer,
                                                         ID3D12Resource& depthBuffer,
                                                         ID3D12Resource& diffuseIrradianceCubeMap,
                                                         ID3D12Resource& ambientAccessibilityBuffer,
