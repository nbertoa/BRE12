...
void ColorNormalCmdListRecorder::InitPSO(const DXGI_FORMAT* geometryBufferFormats, const std::uint32_t geometryBufferCount) noexcept {
	...
	psoParams.mPSFilename = "GeometryPass/Shaders/ColorNormalMapping/PS.cso";
	psoParams.mRootSignFilename = "GeometryPass/Shaders/ColorNormalMapping/RS.cso";
	psoParams.mVSFilename = "GeometryPass/Shaders/ColorNormalMapping/VS.cso";
...
void ColorNormalCmdListRecorder::BuildBuffers(
	...
	// (1 obj cbuffer + 1 material cbuffer + 1 normal texture) per geometry
	descHeapDesc.NumDescriptors = dataCount * 3U; 
