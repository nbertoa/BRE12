...
tbb::empty_task* CommandListProcessor::Create(CommandListProcessor* &cmdListProcessor, Microsoft::WRL::ComPtr<ID3D12CommandQueue>& cmdQueue, const std::uint32_t maxNumCmdLists) {
...
CommandListProcessor::CommandListProcessor(Microsoft::WRL::ComPtr<ID3D12CommandQueue>& cmdQueue, const std::uint32_t maxNumCmdLists)
	: mCmdQueue(cmdQueue)	
