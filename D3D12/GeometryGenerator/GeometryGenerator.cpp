...
GeometryGenerator::MeshData GeometryGenerator::CreateBox(const float width, const float height, const float depth, const std::uint32_t numSubdivisions) noexcept {
    MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateSphere(const float radius, const std::uint32_t sliceCount, const std::uint32_t stackCount) noexcept {
    MeshData meshData;
...
void GeometryGenerator::Subdivide(MeshData& meshData) noexcept {
	...
	for(std::uint32_t i = 0; i < numTris; ++i) {
		...
		const Vertex v0{ inputCopy.mVertices[inputCopy.mIndices32[i3 + 0U]] };
		const Vertex v1{ inputCopy.mVertices[inputCopy.mIndices32[i3 + 1U]] };
		const Vertex v2{ inputCopy.mVertices[inputCopy.mIndices32[i3 + 2U]] };
...
GeometryGenerator::MeshData GeometryGenerator::CreateGeosphere(const float radius, const std::uint32_t numSubdivisions) noexcept {
    MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateCylinder(const float bottomRadius, const float topRadius, const float height, const std::uint32_t sliceCount, const std::uint32_t stackCount) noexcept {
    MeshData meshData;
...
void GeometryGenerator::BuildCylinderTopCap(const float topRadius, const float height, const std::uint32_t sliceCount, MeshData& meshData) noexcept {
...
void GeometryGenerator::BuildCylinderBottomCap(const float bottomRadius, const float height, const std::uint32_t sliceCount, MeshData& meshData) noexcept {
	// 
	// Build bottom cap.
	//
...
GeometryGenerator::MeshData GeometryGenerator::CreateGrid(const float width, const float depth, const std::uint32_t m, const std::uint32_t n) noexcept {
    MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateQuad(const float x, const float y, const float w, const float h, const float depth) noexcept {
    MeshData meshData;
