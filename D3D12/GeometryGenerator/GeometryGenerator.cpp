...
GeometryGenerator::MeshData GeometryGenerator::CreateBox(const float width, const float height, const float depth, const std::uint32_t numSubdivisions) {
    MeshData meshData;
	...
	for (std::uint32_t j = 0; j < clampedNumSubdivisions; ++j) {
		Subdivide(meshData);
	}
...
GeometryGenerator::MeshData GeometryGenerator::CreateSphere(const float radius, const std::uint32_t sliceCount, const std::uint32_t stackCount) {
    MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateGeosphere(const float radius, const std::uint32_t numSubdivisions) {
    MeshData meshData;
...
GeometryGenerator::MeshData GeometryGenerator::CreateCylinder(const float bottomRadius, const float topRadius, const float height, const std::uint32_t sliceCount, const std::uint32_t stackCount) {
    MeshData meshData;
...
void GeometryGenerator::BuildCylinderTopCap(const float topRadius, const float height, const std::uint32_t sliceCount, MeshData& meshData)
{
...
void GeometryGenerator::BuildCylinderBottomCap(const float bottomRadius, const float height, const std::uint32_t sliceCount, MeshData& meshData)
{
	// 
	// Build bottom cap.
	//
...
GeometryGenerator::MeshData GeometryGenerator::CreateGrid(const float width, const float depth, const std::uint32_t m, const std::uint32_t n) {
    MeshData meshData;
